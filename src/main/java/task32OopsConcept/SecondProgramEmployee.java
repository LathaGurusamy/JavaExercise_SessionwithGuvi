package task32OopsConcept;


public class SecondProgramEmployee
{
    ...
    // Constructor
    public SecondProgramEmployee(int id, String firstName, String lastName, int salary) {
        this.id = id;
    ...
    public static void main(String[] args) {
        ...
        SecondProgramEmployee employee = new SecondProgramEmployee(1, "John", "Doe", 50000);
...
Employee Annual Salary: 660000
Employee Information: Employee[id=1, name=John Doe, salary=55000]
****************/
